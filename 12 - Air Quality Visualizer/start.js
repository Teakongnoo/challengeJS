(() => {
  // เริ่มเขียนโค้ด
  const KEY = 'e93ecf21-d207-4fba-9542-fcc80e65e1a6';
  ...
  async function run(){
    ...
    const {aqi, temperature, humidity, wind} = await getAirQuality({ city, state, country }); //parse object by parameter that not interest parameter order 
